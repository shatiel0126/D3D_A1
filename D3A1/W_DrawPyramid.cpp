...
void ShapesApp::BuildShapeGeometry()
{
	...
	boxSubmesh.IndexCount = (UINT)pyramid.Indices32.size();
	...
	auto totalVertexCount = pyramid.Vertices.size();
	...
	geo->DrawArgs["pyramid"] = boxSubmesh;
...
void ShapesApp::BuildRenderItems()
{
	...
	XMStoreFloat4x4(&pytramidRitem->World, XMMatrixScaling(2.0f, 2.0f, 2.0f) * XMMatrixTranslation(0.0f, 0.0f, 0.0f));
	...
	pytramidRitem->IndexCount = pytramidRitem->Geo->DrawArgs["pyramid"].IndexCount;  //36
	pytramidRitem->StartIndexLocation = pytramidRitem->Geo->DrawArgs["pyramid"].StartIndexLocation; //0
	pytramidRitem->BaseVertexLocation = pytramidRitem->Geo->DrawArgs["pyramid"].BaseVertexLocation; //0
