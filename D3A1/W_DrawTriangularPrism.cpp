...
void ShapesApp::BuildShapeGeometry()
{
	...
	boxSubmesh.IndexCount = (UINT)prism.Indices32.size();
	...
	auto totalVertexCount = prism.Vertices.size();
...
void ShapesApp::BuildRenderItems()
{
	...
	pytramidRitem->IndexCount = pytramidRitem->Geo->DrawArgs["prism"].IndexCount;  //36
	pytramidRitem->StartIndexLocation = pytramidRitem->Geo->DrawArgs["prism"].StartIndexLocation; //0
	pytramidRitem->BaseVertexLocation = pytramidRitem->Geo->DrawArgs["prism"].BaseVertexLocation; //0
