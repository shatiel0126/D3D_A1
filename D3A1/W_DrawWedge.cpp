...
void ShapesApp::BuildShapeGeometry()
{
	...
	boxSubmesh.IndexCount = (UINT)wedge.Indices32.size();
	...
	auto totalVertexCount = wedge.Vertices.size();
...
void ShapesApp::BuildRenderItems()
{
	...
	pytramidRitem->IndexCount = pytramidRitem->Geo->DrawArgs["wedge"].IndexCount;  //36
	pytramidRitem->StartIndexLocation = pytramidRitem->Geo->DrawArgs["wedge"].StartIndexLocation; //0
	pytramidRitem->BaseVertexLocation = pytramidRitem->Geo->DrawArgs["wedge"].BaseVertexLocation; //0
